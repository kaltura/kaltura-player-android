...
import com.kaltura.androidx.media3.exoplayer.offline.DownloadCursor;
...
import com.kaltura.androidx.media3.exoplayer.offline.DownloadRequest;
...
import com.kaltura.androidx.media3.exoplayer.dash.DashUtil;
import com.kaltura.androidx.media3.exoplayer.dash.manifest.DashManifest;
import com.kaltura.androidx.media3.exoplayer.hls.HlsManifest;
...
import com.kaltura.androidx.media3.exoplayer.hls.playlist.HlsPlaylist;
...
public class ExoOfflineManager extends AbstractOfflineManager {
    ...
    private final String userAgent = Utils.getUserAgent(appContext) + " " + MediaLibraryInfo.VERSION_SLASHY;
